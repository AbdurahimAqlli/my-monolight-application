...
/**
 * REST controller for managing {@link uz.asz.myapp.domain.Car}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Car> result = carRepository
            ...
            .map(
                existingCar -> {
                    ...
                    if (car.getCarOwnerName() != null) {
                        existingCar.setCarOwnerName(car.getCarOwnerName());
                    }
                    if (car.getYearOfCar() != null) {
                        existingCar.setYearOfCar(car.getYearOfCar());
                    }
