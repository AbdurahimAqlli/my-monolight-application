...
/**
 * REST controller for managing {@link uz.asz.myapp.domain.Group}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Group> result = groupRepository
            ...
            .map(
                existingGroup -> {
                    ...
                    if (group.getBeginDrivingDate() != null) {
                        existingGroup.setBeginDrivingDate(group.getBeginDrivingDate());
                    }
                    ...
                    if (group.getTelegramGroupLink() != null) {
                        existingGroup.setTelegramGroupLink(group.getTelegramGroupLink());
                    }
