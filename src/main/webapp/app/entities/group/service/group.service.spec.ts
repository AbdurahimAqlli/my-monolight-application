  ...
  describe('Group Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = {
        ...
        name: 'AAAAAAA',
        category: Category.B,
        beginDrivingDate: currentDate,
        startDate: currentDate,
        endDate: currentDate,
        telegramGroupLink: 'AAAAAAA',
        status: GroupStatus.BEGIN_LESSONS,
      };
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            beginDrivingDate: currentDate.format(DATE_TIME_FORMAT),
      ...
      describe('addGroupToCollectionIfMissing', () => {
        ...
        it('should add only unique Group to an array', () => {
          const groupArray: IGroup[] = [{ id: 123 }, { id: 456 }, { id: 30246 }];
